...
public class BestSellerBooksRecyclerViewAdapter extends RecyclerView.Adapter<BestSellerBooksRecyclerViewAdapter.BookViewHolder> {
    ...
    public void onBindViewHolder(final BookViewHolder holder, final int position) {
        ...
        holder.mBookDecsription.setText(books.get(position).description);
        holder.mBookBuyBotton.setOnClickListener(new View.OnClickListener(){
            @Override
...
//        holder.mBookImage.setImageDrawable();
    ...
    public class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView mBookDecsription;
        public final Button mBookBuyBotton;
        ...
        public BookViewHolder(View view) {
            ...
            mBookDecsription = (TextView) view.findViewById(R.id.book_description);
            mBookImage = (ImageView) view.findViewById(R.id.book_image);
            mBookBuyBotton = (Button) view.findViewById(R.id.buy_button);
        ...
        public String toString() {
            return mBookRanking.toString() + " '" + mBookTitle.toString() + " '" + mBookAuthor.getText() + "'" +  mBookDecsription.getText() + "'";
        }
    }
}
